// shop-frontend/src/app/services/ui-state.service.ts
...
export class UiStateService { // <-- RENAMED
   ...
   */
  public showToast(message: string, type: 'success' | 'error' | 'info' = 'info', duration: number = 2500): void {
  ...
  // You can add more global UI state signals here
